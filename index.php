                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +84 353 775 914</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> lnhhat13579@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; lnh_Samuel. <a href="https://www.facebook.com/profile.php?id=100035508373396"
